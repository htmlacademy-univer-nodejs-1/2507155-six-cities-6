...
import { BaseController, HttpMethod, HttpRequest, RequestQuery, ValidateDtoMiddleware, ValidateObjectIdMiddleware, PrivateRouteMiddleware } from '../../libs/rest/index.js';
...
export class OfferController extends BaseController {
  ...
  public async indexPremium({ params, tokenPayload }: Request<CityRequestParam>, res: Response): Promise<void> {
    ...
    const premiumOffers = await this.offerService.findPremiumByCity(params.city, tokenPayload.id);
